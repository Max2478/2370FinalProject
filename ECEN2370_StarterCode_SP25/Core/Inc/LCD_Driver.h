...
void LCD_Draw_Square_Fill(uint16_t Xpos, uint16_t Ypos, uint16_t radius, uint16_t color);
void LCD_Draw_Rectangle_Fill(uint16_t Xpos, uint16_t Ypos, uint16_t sizeX, uint16_t sizeY, uint16_t color);
